...
<template>
  <div class="flex flex-1 justify-center py-5 bg-white dark:bg-gray-900 text-[#121416] dark:text-white px-4 sm:px-6 md:px-10 lg:px-40">
    <div class="layout-content-container flex flex-col w-full max-w-[640px]">
      ...
      <div class="flex flex-col sm:flex-row gap-3">
        <button
            @click="createDeck"
            class="flex items-center justify-center cursor-pointer overflow-hidden rounded-full h-10 px-5 bg-[#f1f2f4] dark:bg-indigo-600 text-[#121416] dark:text-white text-sm font-medium hover:bg-[#e1e2e4] dark:hover:bg-indigo-700 transition w-full sm:w-auto"
        >
          Salvar Deck
        </button>
        ...
        <button
            @click="router.back()"
            class="flex items-center justify-center cursor-pointer overflow-hidden rounded-full h-10 px-5 bg-transparent border border-[#f1f2f4] dark:border-gray-700 text-sm text-[#121416] dark:text-white hover:bg-[#f1f2f4] dark:hover:bg-gray-700 transition w-full sm:w-auto"
        >
          Cancelar
        </button>
      </div>
